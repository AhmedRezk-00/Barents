...
\section{Implementation}\label{Section4}
    \subsection{Discussion on own implementation vs. existing tools}
        ...
        \subsubsection{implementing ourselves}
            ...
            The second mockup improved the program architecture and experimented with the pyhon library RDFLib in order to keep the application for more structured. 
            Essentially the focus was on managing the rdf graph seperately from its representation in the editor. 
...
\section{Prototyping}\label{Section5}
    ...
    \subsection{Data Access and the Expanded BARENTS Ontology}
        ...
        This information is then modeled as two seperate literals.

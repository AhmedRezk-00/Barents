...
However, for future projects, one could extend the processing engine to Transformations II (map) and III (reduce) and improve compatibility with other databases.  

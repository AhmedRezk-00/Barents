...
\section{Implementation}\label{Section4}
    \subsection{Discussion on own implementation vs. existing tools}
        ...
        \subsubsection{implementing ourselves}
            ...
            These mockups were early attempts at implementing a BARENTS editor, each focusing on different challenges.
...
\end{figure*}
The User Interface for the Barents project, in \autoref{BARENTS-editor},

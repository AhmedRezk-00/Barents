...
\end{figure}
The User Interface for the Barents project (pictured in \autoref{BARENTS-editor}) is built on CustomTkinter, a Python library that provides a modern look for the user interface. 
